...
import { ENGINE_ORDER, ENGINE_LABELS, MARKET_LABELS, matches } from "../scoring";
...
export async function buildReportPdf({
  ...
  const summaryParagraph =
    `We asked ChatGPT, Gemini and Claude the questions real shoppers ask about ${categoryName || "this category"} in ${marketLabel}. ` +
