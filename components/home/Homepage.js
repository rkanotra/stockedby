...
import AgentCommerceMotion from './AgentCommerceMotion';
  ...
  return <div className={styles.home} id="top">
    ...
    <main id="main-content">
      ...
      <section className={`${styles.marketSection} ${styles.container}`} id="markets">
        ...
        <div className={styles.technical}><div><span className={styles.kicker}>NEW / PURCHASE CHECK</span><h3>From product discovery to a usable cart.</h3><p>Check the exact variant, price and buying journey. Get evidence, fix guides and a repeatable check.</p></div><Link href="/purchase-check" className={styles.outlineButton}>Explore Purchase Check <span aria-hidden="true">↗</span></Link></div>
      </section>
